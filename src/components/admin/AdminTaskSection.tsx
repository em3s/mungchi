...
export function AdminTaskSection({ showToast }: Props) {
  // 벌크 추가
  const [selectedChildren, setSelectedChildren] = useState<string[]>(["sihyun", "misong"]);
  ...
  useEffect(() => {
    loadClonePreview();
  }, [cloneChildId, cloneSourceDate, loadClonePreview]);
